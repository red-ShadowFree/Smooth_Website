...
function bindControls() {
  ...
  document.getElementById('down').addEventListener('click', playerMoveDown);
  document.getElementById('rotate').addEventListener('click', playerRotateClockwise);
  ...
  document.addEventListener('keydown', (event) => {
    ...
    } else if (event.keyCode === 17 || event.keyCode === 88) {
